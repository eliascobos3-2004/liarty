...
class _InfoScreenState extends State<InfoScreen> {
  ...
  Future<void> _pickProfileImage() async {
    ...
    if (image != null) {
      Hive.box('liarty_prefs').put('profile_image_path', image.path);
      setState(() {});
    }
  }
  ...
  Future<void> _pickBackgroundImage() async {
    ...
    if (image != null) {
      final box = Hive.box('liarty_prefs');
      box.put('bg_type', 'custom_image');
      box.put('custom_bg_path', image.path);
      setState(() {});
    }
  }
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
        ...
        builder: (context, box, _) {
          ...
          final String evalTime =
              box.get('evaluation_time', defaultValue: '21:00');
          final String? profilePath = box.get('profile_image_path');
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        Card(
                            ...
                            child: Column(
                              children: [
                                ...
                                TextField(
                                  ...
                                  onChanged: (val) => box.put('user_name', val),
                                ),
                                TextButton.icon(
                                  onPressed: () async {
                          ...
                          color: Colors.white
                              .withOpacity(0.9), // Fondo para legibilidad
                        ),
                        ...
                        ElevatedButton.icon(
                          ...
                          label: const Text(
                              "Vista Previa: Plantilla de Cumplimiento"),
                          style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  const Color.fromARGB(255, 156, 82, 12),
                        ...
                        Card(
                          child: Column(
                            children: [
                              const ListTile(
                                  title: Text("Fondo: Colores Sólidos")),
                              Row(
                                mainAxisAlignment:
                              ...
                              ElevatedButton.icon(
                                ...
                                label: const Text("Subir fondo personalizado"),
                                style: ElevatedButton.styleFrom(
                                  backgroundColor:
                                      box.get('bg_type') == 'custom_image'
                                          ? Colors.black
      ...
      MaterialPageRoute(
        builder: (context) => CompletionPage(
          ...
          eventData: {
            ...
            'id': Uuid().v4(), // Provide a dummy ID for consistency
